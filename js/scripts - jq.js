...
/* Common functions BEGIN */
  function positionNavElems() {
    ...
    if (largeImg.length) {
      ...
      arrows.css('margin-top': 0 - arrows.css('height') / 2 + 'px'});
    ...
    close.css('margin-left': mainElem.innerWidth / 2 - close.css('width') + 'px'});
    close.css('margin-top': 0 - mainElem.innerHeight() / 2 - 40 + 'px'});
  }
